...
from app.services.llm_service import extract_average_gross_weight_from_document
...
if __name__ == "__main__":
    ...
    avg_numbers_list, avg_numbers = extract_average_gross_weight_from_document(result)
